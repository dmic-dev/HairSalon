...
public class ContactOverviewManager {
    ...
    public ObservableList<ContactViewDetailsDto> getContactDtoList(List<Contact> contacts){
        ContactDtoManager contactDtoManager = springContext.getBean(ContactDtoManager.class);
        ObservableList<ContactViewDetailsDto> observableDtoList = FXCollections.observableArrayList();
        List<ContactViewDetailsDto> contactDtoList = contacts.stream()
