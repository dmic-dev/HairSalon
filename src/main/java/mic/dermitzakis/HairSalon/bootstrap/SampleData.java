...
import mic.dermitzakis.HairSalon.repository.DataAccessService;
...
public class SampleData implements DataAccessService{
...
//        pic.setImage(Picture.toByteArray(image));
        ...
        pictureList = List.of(newPicture("Me.jpg"), newPicture("Eleni.jpg"),newPicture("Γιώργος-Προσαρμοσμένο.jpg"));
        
        contactList = List.of(       //Immutable list
            newContactBean("Martin Neil", "Welsch", Gender.MALE, null),
            newContactBean("Jill", "Andrews",Gender.FEMALE, null), 
            newContactBean("Γιώργος", "Τζουγκανάκης",Gender.MALE, pictureList.get(2)), //newImage("Γιώργος-Προσαρμοσμένο.jpg"
            ...
            newContactBean("ΕΛΕΝΗ", "ΚΑΠΑΔΟΥΚΑΚΗ",Gender.FEMALE, pictureList.get(1)),     
            ...
            newContactBean("Mary", "Johnson",Gender.FEMALE, null)
        );
        
        CacheService dataLoaderService = springContext.getBean(CacheService.class);
    ...
    private Picture newPicture(String filename) throws IOException {
        Image image = new Image("file:"+getClass().getResource("/images/"+filename).getPath());
        Picture picture = new Picture();
        picture.setByteArray(Picture.imageToByteArray(image));
        return picture;
    }
